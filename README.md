...
| Experiment | Architecture | LR | Epochs | Test MAE (kcal/mol) |
|---|---|---|---|---|
| Baseline | 384→256→192→128→1 | 1e-4 | 30 | 7.89 |
| More epochs | 384→256→192→128→1 | 1e-4 | 100 | 3.51 |
| Extended | 384→256→192→128→1 | 1e-4 | 200 | 2.42 |
| Bigger net | 384→512→256→128→1, DO=0.15 | 1e-4 | 200 | 2.42 |
| Lower dropout | 384→512→256→128→1, DO=0.05 | 1e-4 | 200 | **1.17** |
| No dropout | 384→512→256→128→1, DO=0 | 1e-4 | 200 | 4.92 |
| 10-fold CV best | 384→512→256→128→1, DO=0.05 | 1e-4 | 200 | **1.01** |
